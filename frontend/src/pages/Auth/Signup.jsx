        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 p-8 lg:p-12">
            ...
            >
              ...
              <p className="text-gray-600 mb-8">with one of these services</p>
          ...
          >
            <p className="text-gray-600 mb-8">with your email address</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <label className="flex items-start space-x-3 text-sm text-gray-700">
                  ...
                  <span>
                    I agree to the{" "}
                    <a className="text-blue-600 hover:text-blue-700 underline">Terms</a>{" "}
                    and{" "}
